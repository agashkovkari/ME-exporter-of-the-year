...
<section class="tw-wrapper md:tw-flex md:tw-items-center md:tw-min-h-[350px] lg:tw-h-[620px] tw-border-0">
  <div class="tw-wrap md:tw-flex md:tw-items-center md:tw-w-full md:tw-h-full tw-z-0">
    <div class="md:tw-w-3/5 lg:tw-w-3/4">
      ...
      <div class="md:tw-absolute md:tw-top-0 md:tw-right-12.5 md:tw-bottom-0 md:tw-flex md:tw-justify-end md:tw-items-center md:tw-max-w-1/2 -tw-z-10">
...
<section class="tw-wrapper tw-border-0">
  <div class="tw-wrap">
    ...
    <div class="tw-mt-5">
      <div class="tw-mb-5"><a class="tw-underline" href="https://moscow-export.com/upload/File%20on%20site/Положение_МЭЦ_Экспортер_года_2022.pdf" target="_blank">Положение о проведении ежегодного регионального конкурса «Экспортер года»</a></div>
...
<section class="tw-wrapper tw-border-0">
  <div class="tw-wrap">
    ...
    <div class="tw-flex tw-flex-col lg:tw-flex-row tw-gap-x-20 tw-gap-y-9 md:tw-gap-y-17">
      <div class="tw-relative tw-flex tw-items-center lg:tw-flex-1 tw-h-[80px] md:tw-h-[140px] tw-ml-3 md:tw-ml-6.5 tw-p-7.5 tw-pl-15 md:tw-pl-25 tw-bg-mec-gray-300 hover:tw-bg-[#D94949] hover:tw-text-white tw-font-bold tw-shadow-[0px_4px_10px_rgba(0,0,0,0.3)]">
        <div>
    ...
    <div class="tw-flex tw-flex-col lg:tw-flex-row tw-gap-x-20 tw-gap-y-9 md:tw-gap-y-17 tw-mt-9 md:tw-mt-17 lg:tw-mt-20">
    ...
    <div class="tw-flex tw-flex-col lg:tw-flex-row tw-gap-x-20 tw-gap-y-9 md:tw-gap-y-17 tw-mt-9 md:tw-mt-17 lg:tw-mt-20">
      ...
      <div class="tw-hidden lg:tw-flex lg:tw-flex-1 tw-h-[80px] md:tw-h-[140px] tw-ml-3 md:tw-ml-6.5 tw-p-7.5 tw-pl-15 md:tw-pl-25">
        &nbsp;
      </div>
    </div>
...
<section class="tw-wrapper tw-relative -tw-z-10 border-0 tw-bg-mec-gray-300">
  <div class="tw-wrap">
    ...
    <div class="tw-flex tw-flex-col lg:tw-flex-row tw-gap-x-20 tw-gap-y-7.5 lg:tw-gap-y-12.5" style="counter-reset: num">
      <div class="tw-flex-1">
        <ul>
...
<section class="tw-wrapper border-0">
  <div class="tw-wrap lg:tw-mt-12.5">
    <div class="tw-flex tw-flex-col-reverse lg:tw-flex-row lg:tw-justify-between lg:tw-items-center tw-gap-y-7.5 tw-gap-x-20">
      <div class="tw-pt-[120px] lg:tw-pt-0 tw-flex-1 tw-flex-shrink-0">
        <h3 class="tw-font-bold tw-text-mec-red-300">Прием заявок</h3>
        <div class="tw-flex tw-gap-x-6 tw-justify-between lg:tw-justify-start tw-items-end tw-mt-5 tw-mb-12.5 tw-pl-7.5 2.5 tw-font-bold">
          ...
          <div class="tw-block md:-tw-mb-4">до <span class="tw-h1 md:tw-text-[3.5rem] tw-font-bold">27 апреля</span>
          </div>
        </div>
        ...
        <div class="tw-flex tw-gap-x-6 tw-justify-between lg:tw-justify-start tw-items-end tw-mt-5 tw-mb-12.5 tw-pl-7.5 2.5 tw-font-bold">
          ...
          <div class="tw-block md:-tw-mb-4"><span class="tw-h1 md:tw-text-[3.5rem] tw-font-bold">28 апреля</span>
          </div>
        </div>
      ...
      <svg class="tw-absolute tw-top-0 lg:tw-static tw-flex tw-justify-end tw-self-end lg:tw-self-center tw-flex-1 tw-w-[125px] md:tw-w-[240px] lg:tw-w-[417px] tw-h-[125px] md:tw-h-[240px] lg:tw-h-[417px]" viewBox="0 0 417 417" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M22 60H103.391H415V415H22V60Z" fill="white" stroke="#C00D0D" stroke-width="4" stroke-linecap="square" />
        <rect x="1" y="35.4484" width="389.847" height="351.785" fill="white" />
        <path d="M82.8909 35.4484H2.15344V387.233H392V35.4484H318.183" stroke="#C00D0D" stroke-width="4" stroke-linecap="square" />
      ...
      <svg class="tw-absolute tw-top-[40%] lg:-tw-top-[150px] -tw-right-[50px] lg:-tw-right-[150px] -tw-z-20 tw-w-[180px] lg:tw-w-[391px] tw-h-[180px] lg:tw-h-[391px] md:tw-hidden lg:tw-block" width="391" height="391" viewBox="0 0 391 391" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="195.5" cy="195.5" r="193.5" stroke="#C00D0D" stroke-width="4" stroke-dasharray="10 10" />
      </svg>
      <div class="tw-absolute -tw-top-[50px] md:-tw-top-[100px] lg:-tw-top-[20px] -tw-right-[110px] md:-tw-right-[220px] lg:-tw-right-[430px] -tw-z-10">
        <img class="tw-w-[200px] md:tw-w-[400px] lg:tw-w-[748px] tw-h-[200px] md:tw-h-[400px] lg:tw-h-[743px]" src="./img/red_square.png" alt="">
      </div>
    </div>
  </div>
</section>
...
<section class="tw-wrapper border-0">
  <div class="tw-wrap tw-pt-12.5">
    ...
    <div class="tw-relative tw-flex tw-flex-col lg:tw-flex-row tw-gap-x-20 tw-gap-y-7.5 tw-py-13.5 md:tw-py-20 tw-px-7.5 md:tw-px-13.5 tw-p-20 tw-border tw-border-mec-red-300 tw-rounded-[25px] md:tw-rounded-[45px] tw-bg-white">
      <div class="tw-flex-1">
